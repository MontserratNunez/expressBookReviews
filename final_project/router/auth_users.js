...
regd_users.put("/auth/review/:isbn", (req, res) => {
    ...
    if (!review) {
        return res.status(400).json({ message: "Review content is required as a query parameter (?review=...)" });
    }
...
regd_users.delete("/auth/review/:isbn", (req, res) => {
    ...
    // Verificar si el usuario actual tiene una reseña publicada en este libro
